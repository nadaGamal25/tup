  ...
  async function sendDataToApi() {
    ...
    try {
      ...
      if (response.status === 200) {
        setisLoading(false);
        window.alert("تم التسجيل فى منصة جوتكس بنجاح");
...
const closeCitiesList = (index) => {
  ...
  return (
    <>
    <div className='d-flex min-vh-100 p-5 register-client-container' >
    <div className="register-client-box m-auto">
    ...
    <img className='m-auto logo' src={logo} alt="logo" />
        ...
        <label htmlFor="name">الاسم  :<span className="star-requered">*</span></label>
      <input onChange={getData} type="text" className='my-input my-2 form-control' name='name' />
